    ...
    cart.items.forEach(item => {
      ...
      itemEl.innerHTML = `
        ...
        <div class="cart-item__info">
          ...
          ${item.selling_plan_allocation ? `<p class="cart-item__selling-plan">${escHtml(item.selling_plan_allocation.selling_plan.name)}</p>` : ''}
          <div class="cart-item__controls">
            ...
            <div class="cart-item__price-wrap">
              ...
              ${item.unit_price_measurement ? `<span class="cart-item__unit-price">${formatMoney(item.unit_price)}/${escHtml(item.unit_price_measurement.reference_unit)}</span>` : ''}
            </div>
          </div>
        </div>
      `;
